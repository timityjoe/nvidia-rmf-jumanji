...
from og_marl_tjt.og_marl.offline_tools import offline_environment_logger
...
def train(cfg: omegaconf.DictConfig, log_compiles: bool = False) -> None:
    ...
    print("1) Setup OG-MARL Offline Data Logger")
    env_offline = offline_environment_logger(env)
